...
## For future Claude
Person note for Jacqueline A. Quandt, co-author with [[Cheryl Wellington]] on 3 OpenAlex-indexed papers. Co-publication span: 2021–2023. Built from openalex.org co-authorship metadata (as of 2026-05-05). Affiliations and current role NOT captured here — re-derive from OpenAlex `/authors` if needed.
